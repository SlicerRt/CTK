...
if(${add_project})
  ...
  if(CTK_SUPERBUILD)
    ...
    if(NOT DEFINED DCMTK_DIR)
      ...
      # Force using private DCMTK version (with RT support)
      set(location_args )
      set(location_args SVN_USERNAME "anonymous"
                        SVN_PASSWORD ""
                        SVN_REPOSITORY "https://subversion.assembla.com/svn/slicerrt/trunk/SlicerRt/src/DCMTK")
